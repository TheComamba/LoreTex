...
\newcommand{\born}[3][]{
	\addHistory[#1]{#2}{#3}
	\directlua{SetProtectedDescriptor(CurrentEntity(), "born", #2)}
}
\newcommand{\died}[3][]{
	\addHistory[#1]{#2}{#3}
	\directlua{SetProtectedDescriptor(CurrentEntity(), "died", #2)}
}
\newcommand{\bornInFmt}[4][]{
	\addHistoryInFmt[#1]{#2}{#3}{#4}
	\directlua{SetProtectedDescriptor(CurrentEntity(), "born", ConvertYearToVin(#3, #2))}
}
\newcommand{\diedInFmt}[4][]{
	\addHistoryInFmt[#1]{#2}{#3}{#4}
	\directlua{SetProtectedDescriptor(CurrentEntity(), "died", ConvertYearToVin(#3, #2))}
}

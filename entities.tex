...
\newcommand{\spellProperties}[6]{
	\directlua{
		SetDescriptor(CurrentLabel, "Properties", "#1","Level:")
		SetDescriptor(CurrentLabel, "Properties", "#2","School:")
		SetDescriptor(CurrentLabel, "Properties", "#3","Casting-time:")
		SetDescriptor(CurrentLabel, "Properties", "#4","Range:")
		SetDescriptor(CurrentLabel, "Properties", "#5","Components:")
		SetDescriptor(CurrentLabel, "Properties", "#6","Duration:")
	}
}
...
\newcommand{\setPlayer}[1]{
	\directlua{
		SetDescriptor(CurrentLabel,[[Spieler]],[[\detokenize{#1}]])
	}
}

\newcommand{\setHeight}[1]{
	\directlua{
		SetDescriptor(CurrentLabel,[[Höhe]],[[\detokenize{#1}m]])
	}
}
...
\newcommand{\setAssociation}[2][]{
	\directlua{SetAssociation(CurrentLabel, "#2", [[\detokenize{#1}]])}
}

\newcommand{\setSecret}{
	\directlua{SetSecret(CurrentLabel)}
}

\newcommand{\showSecrets}{
	\directlua{ShowSecrets = true}
}

...
\newcommand{\addDescriptor}[3][]{\directlua{TexApi.setDescriptor{ entity = CurrentEntity(), descriptor = [[\detokenize{#2}]], description = [[\detokenize{#3}]], subdescriptor = [[\detokenize{#1}]] }}}

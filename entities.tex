...
\newcommand{\spellProperties}[6]{
	\directlua{
		SetDescriptor(CurrentLabel,"level", "#1")
		SetDescriptor(CurrentLabel,"school", "#2")
		SetDescriptor(CurrentLabel,"casting-time", "#3")
		SetDescriptor(CurrentLabel,"range", "#4")
		SetDescriptor(CurrentLabel,"components", "#5")
		SetDescriptor(CurrentLabel,"duration", "#6")
	}
}

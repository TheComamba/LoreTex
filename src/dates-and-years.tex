\newcommand{\setCurrentYear}[1]{\directlua{TexApi.setCurrentYear(#1)}}
\newcommand{\setCurrentDay}[1]{\directlua{TexApi.setCurrentDay(#1)}}
\newcommand{\setDaysPerYear}[1]{\directlua{TexApi.setDaysPerYear(#1)}}

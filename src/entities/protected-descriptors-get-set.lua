...
StateResetters[#StateResetters + 1] = function()
    ...
    addProtectedDescriptor("additionalConcerns")
    ...
    addProtectedDescriptor("isGenerated")
    ...
    addProtectedDescriptor("notConcerns")
    addProtectedDescriptor("onlyConcerns")
    addInheritableDescriptor("parents")
    addProtectedDescriptor("partOf")
    addProtectedDescriptor("properties")
    addProtectedDescriptor("shortname")
    addInheritableDescriptor("species")
    addProtectedDescriptor("timestamp")

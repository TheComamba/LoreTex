...
Append(expected, [[\RpgTexSort{9} zzz]])
Append(expected, [[\RpgTexSort{88} aaa]])
Append(expected, [[\RpgTexSort{193}newEntity was called 193 times.]])
Append(expected, [[\RpgTexSort{1679}addTranslation was called 1679 times.]])

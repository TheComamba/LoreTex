TexApi.newEntity { category = "places", label = "test-place-1", name = "Test Place 1" }
...
TexApi.newEntity { category = "places", label = "test-place-2", name = "Test Place 2" }
...
TexApi.newEntity { category = "places", label = "test-place-3", name = "Test Place 3" }

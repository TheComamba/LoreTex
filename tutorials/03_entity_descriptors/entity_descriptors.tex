...
\RpgTex{} prints only the descriptors of entities referred to by the reference command, sorted alphabetically. You may notice, though, that the description of \reference{sting} mentions another entity, which is therefore also put into the Only Mentioned chapter at the end.
